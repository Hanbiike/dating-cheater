...
from src.utils.exceptions import OpenAIError, ValidationError, safe_execute
...
class ResponseGenerator:
    ...
    def _get_fallback_response(self) -> str:
        ...
        # Ранее ответ выбирался случайно, что приводило к недетерминированному
        # поведению и падению тестов. Для стабильности возвращаем
        # предсказуемый фолбэк.
